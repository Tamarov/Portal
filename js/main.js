...
function topMenuOnLineRadio(){
	...
	if(0 == topMenuOnLineRadioFlag){
		radioImg.style.backgroundImage = "url(file:///D:/portal/img/online-radio-on.png";
...
function topMenuMusic(){
	...
	if(0 == topMenuMusicFlag){
		musicImg.style.backgroundImage = "url(file:///D:/portal/img/music-on.png";
...
function topMenuPlaylist(){
	...
	if(0 == topMenuPlaylistFlag){
		playlistImg.style.backgroundImage = "url(file:///D:/portal/img/top-menu-playlist-on.png";
